...
# GCond中的data,GMETA中的子图
class MetaGraph:
    def __init__(self, root, mode, subgraph2label, n_way, k_shot, k_query, batchsz, args, adj, h):
        self.batchsz = batchsz  # batch of set, not batch of subgraphs
        self.n_way = n_way  # n-way分类问题
    ...
    def loadCSV(self, csvf):
        ...
        print(dictLabels, dictGraphs, dictGraphsLabels)
